...
<html>
  ...
  <!-- Facebook and Twitter integration -->
    ...
    <link rel="stylesheet" href="{{ asset('kcnew/frontend/css/colors/theme-color-11.css') }}" id="changeColorScheme">
					...
					<ul class="header--menu-links nav navbar-nav" data-trigger="hoverIntent">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="{{ route('blog.home') }}">Blog cá nhân</a></li>
