										...
										<div class="post--item post--layout-1 post--title-large">
												<div class="post--img">
														...
														<div class="post--info">
																...
																<div class="title">
																		<h2 class="h4"><a href="{{ route('posts.show', $posts_new[$i][0]) }}" class="btn-link">{{ $posts_new[$i][0]->title }}</a></h2>
																</div>
														</div>
												</div>
										</div>
							...
							<div class="list--widget list--widget-2" data-ajax-content="outer">
								...
								<div class="post--items post--items-3">
									<ul class="nav" data-ajax-content="inner">
										...
										@if($ad->position == 'center')
										<a href="{{ $ad->link }}">
											<div class="ad-banner" style="position: relative; display: flex; justify-content: center; align-items: center; width: 100%; max-width: 500px; max-height: 200px; overflow: hidden; margin-top: 30px; z-index: 999999;">
												<!-- Hiển thị tiêu đề "HOT HOT HOT" -->
												<h3 style="position: absolute; top: 20px; left: 50%; transform: translateX(-50%); font-size: 24px; color: white; font-weight: bold; z-index: 10;">HOT HOT HOT</h3>
