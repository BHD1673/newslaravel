                            ...
                            <div class="col-lg-12">
                                <div class="border border-3 p-4 rounded">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" value="{{ old('name') }}" required class="form-control" placeholder="Nhập tên sản phẩm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="price" value="{{ old('price') }}" required class="form-control" placeholder="Nhập giá sản phẩm">
                                        @error('price')<p class="text-danger">{{ $message }}</p>@enderror
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Giá cũ</label>
                                        <input type="number" name="old_price" value="{{ old('old_price') }}" class="form-control" placeholder="Nhập giá cũ (nếu có)">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Hàng tồn kho</label>
                                        <input type="number" name="stock" value="{{ old('stock', 0) }}" required class="form-control" placeholder="Nhập số lượng hàng tồn kho">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="product_status_id" required class="form-select">
                                        ...
                                        @error('product_status_id')<p class="text-danger">{{ $message }}</p>@enderror
                                    </div>
                                    <div class="mb-3">
