    ...
    <li>
        ...
        <ul>
            @if(checkPermission("admin.products.index"))
                <li><a href="{{ route('admin.products.index') }}"><i class="bx bx-right-arrow-alt"></i>Tất cả sản phẩm</a></li>
            @endif

            @if(checkPermission("admin.products.create"))
                <li><a href="{{ route('admin.products.create') }}"><i class="bx bx-right-arrow-alt"></i>Thêm sản phẩm mới</a></li>
            @endif
        </ul>
    </li>
    @endif --}}
