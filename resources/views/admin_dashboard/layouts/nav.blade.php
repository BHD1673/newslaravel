...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        @if(checkPermission("admin.post-history.index"))
                        <li> <a href="{{ route('admin.post-history.index') }}"><i class="bx bx-history"></i>Lịch sử thao
                                tác</a>
                        </li>
                        @endif
                    </ul>
                ...
                <li>
                    ...
                    <ul>
                        @if(checkPermission("admin.post-soft-delete"))
                        <li> <a href="{{ route('admin.post-soft-delete') }}"><i class="bx bx-trash"></i>Bài viết đã
                                xóa</a>
                        </li>
                        @endif
                    </ul>
        ...
        <li>
            ...
            <ul>
                @if(checkPermission("admin.categories.index"))
                <li> <a href="{{ route('admin.categories.index') }}"><i class="bx bx-right-arrow-alt"></i>Tất cả danh
                        mục</a>
                </li>
                @endif

                @if(checkPermission("admin.categories.create"))
                <li> <a href="{{ route('admin.categories.create') }}"><i class="bx bx-right-arrow-alt"></i>Thêm danh mục
                        mới</a>
                </li>
                @endif
            </ul>
        ...
        <li>
            ...
            <ul>
                @if(checkPermission("admin.comments.index"))
                <li> <a href="{{ route('admin.comments.index') }}"><i class="bx bx-right-arrow-alt"></i>Tất cả bình
                        luận</a>
                </li>
                @endif

                @if(checkPermission("admin.comments.create"))
                <li> <a href="{{ route('admin.comments.create') }}"><i class="bx bx-right-arrow-alt"></i>Thêm bình luận
                        mới</a>
                </li>
                @endif
        ...
        <li>
            ...
            <ul>
                @if(checkPermission("admin.post-history.index"))
                <li> <a href="{{ route('admin.post-history.index') }}"><i class="bx bx-history"></i>Lịch sử thao tác</a>
                </li>
                @endif
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                ...
                @if(checkPermission("admin.users.create"))
                <li> <a href="{{ route('admin.users.create') }}"><i class="bx bx-right-arrow-alt"></i>Thêm tài khoản
                        mới</a>
                </li>
                @endif
