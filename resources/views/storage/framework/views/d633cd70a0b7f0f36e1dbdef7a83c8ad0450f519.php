            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Thông bài viết của tài khoản:  <?php echo e($user->name); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
