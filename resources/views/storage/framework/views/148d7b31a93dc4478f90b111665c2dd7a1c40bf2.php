...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <?php if(checkPermission("admin.post-history.index")): ?>
                <li> <a href="<?php echo e(route('admin.post-history.index')); ?>"><i class="bx bx-history"></i>Lịch sử Bài viết</a>
                </li>
                <?php endif; ?>
            </ul>
        </li>
...
<!--end sidebar wrapper --><?php /**PATH D:\laragon\www\newslaravel-main\newslaravel-main\resources\views/admin_dashboard/layouts/nav.blade.php ENDPATH**/ ?>