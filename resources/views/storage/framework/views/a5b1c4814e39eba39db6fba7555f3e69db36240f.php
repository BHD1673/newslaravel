													...
													<div class="col-md-4">
														<?php for($i = $start ; $i < $end ; $i++): ?>
															<label class="permission">
																<input type="checkbox" name="permissions[]" value="<?php echo e($permissions[$i]->id); ?>"></input>
