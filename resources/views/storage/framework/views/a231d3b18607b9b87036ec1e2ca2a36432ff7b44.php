<?php $__env->startSection('title','TDQ - Tin Tức mới nhất'); ?>
                                ...
                                <div class="col-md-12 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items post--items-2" data-ajax-content="outer">
                                        <ul class="nav" data-ajax-content="inner">
											<?php for($i =0 ; $i < count($newPosts_category) ; $i++): ?>
                                            <li>
                                                <!-- Post Item Start -->
                                                <div class="post--item">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="post--img">
                                                                <a href="<?php echo e(route('posts.show', $newPosts_category[$i] )); ?>"
                                                                    class="thumb"><img
                                                                        src="<?php echo e(asset($newPosts_category[$i]->image ? 'storage/' . $newPosts_category[$i]->image->path : 'storage/placeholders/placeholder-image.png'  )); ?>"
                                                                        alt=""></a>
                                                                <a href="<?php echo e(route('categories.show', $newPosts_category[$i]->category)); ?>"
                                                                    class="cat"><?php echo e($newPosts_category[$i]->category->name); ?></a>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="post--info">
                                                                <ul class="nav meta">
																	<li><span><?php echo e($newPosts_category[$i]->author->name); ?></a></li>
																	<li><span><?php echo e($newPosts_category[$i]->created_at->locale('vi')->diffForHumans()); ?></span></li>
                                                                    <li><a href="#"><i class="fa fm fa-eye"></i><?php echo e($newPosts_category[$i]->views); ?></span></li>
                                                                    <li><a href="<?php echo e(route('posts.show', $newPosts_category[$i] )); ?>"><i class="fa fm fa-comments"></i><?php echo e(count($newPosts_category[$i]->comments)); ?></a></li>
                                                                </ul>


                                                                <div class="title">
                                                                    <h2 class="h3" style="color:black"><a
                                                                            href="<?php echo e(route('posts.show', $newPosts_category[$i] )); ?>"
                                                                            class="btn-link"><?php echo e($newPosts_category[$i]->title); ?></a></h3>
                                                                </div>
                                                            </div>

                                                            <div class="post--content">
                                                                <p><?php echo e($newPosts_category[$i]->excerpt); ?></p>
                                                            </div>

                                                            <div class="post--action">
                                                                <a class="btn btn-link" href="<?php echo e(route('posts.show', $newPosts_category[$i] )); ?>">Đọc thêm</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
