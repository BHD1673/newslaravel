...
<!--start header -->
                ...
                <nav class="navbar navbar-expand">
                            ...
                            <li class="nav-item dropdown dropdown-large">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <div class="header-message-list">
                                        <?php for($i = 0; $i < 10 ; $i++ ): ?>
                                        <a class="dropdown-item" href="<?php echo e(route('posts.show', $posts_comments[$i][0] )); ?>">
                                            <div class="d-flex align-items-center">
                                                <div class="user-online">
                                                    <img class="img_admn--user img-avatar " width="50" height="50" style="border-radius: 50% ; margin: auto; background-size: cover ;  background-image: url(<?php echo e($posts_comments[$i][0]->comments()->orderBy('id','DESC')->take(1)->get()[0]->user->image ?  asset('storage/' . $posts_comments[$i][0]->comments()->orderBy('id','DESC')->take(1)->get()[0]->user->image->path) : asset('storage/placeholders/user_placeholder.jpg')); ?>)" alt="">
                                                </div>
                                                <div style="margin-left: 10px;" class="flex-grow-1">
                                                    <h6 class="msg-name"><?php echo e($posts_comments[$i][0]->comments()->orderBy('id','DESC')->take(1)->get()[0]->user->name); ?><span class="msg-time"> đã bình luận bài viết</span></h6>
                                                    <h6 class="msg-name"><?php echo e(Str::limit($posts_comments[$i][0]->title,32)); ?></h6>
                                                </div>
                                            </div>
                                        </a>
                                        <?php endfor; ?>
                    ...
                    <div class="user-box dropdown">
                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img class="img_admn--user img-avatar " width="50" height="50" style="border-radius: 50% ; margin: auto; background-size: cover ;  background-image: url(<?php echo e(auth()->user()->image ?  asset('storage/' . auth()->user()->image->path) : asset('storage/placeholders/user_placeholder.jpg')); ?>)" alt="">
        ...
        <!--end header --><?php /**PATH C:\laragon\www\Project\newslaravel\resources\views/admin_dashboard/layouts/header.blade.php ENDPATH**/ ?>