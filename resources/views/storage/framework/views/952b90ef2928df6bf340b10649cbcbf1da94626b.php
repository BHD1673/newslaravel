                ...
                <form action="#">
                    <div class="checkbox">
                        <label>
                            ...
                            <img src="<?php echo e(asset('kcnew/frontend/img/Flag_barzill.png')); ?>" alt="Brasil" srcset="">
                            <span>Brasil</span>
                        </label>
                    ...
                    <div class="checkbox">
                        <label>
                            ...
                            <img src="<?php echo e(asset('kcnew/frontend/img/Flag_Agrennal.png')); ?>" alt="Brasil" srcset="">
                            <span>Argentina</span>
                        </label>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option-2">
                            <img src="<?php echo e(asset('kcnew/frontend/img/Flag_tay_ban_nha.png')); ?>" alt="Brasil" srcset="">
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option-2">
                            <img src="<?php echo e(asset('kcnew/frontend/img/Flag_bo-dao-nha.png')); ?>" alt="Brasil" srcset="">
...
<!-- Widget End --><?php /**PATH C:\laragon\www\Project\newslaravel\resources\views/components/blog/side-vote.blade.php ENDPATH**/ ?>