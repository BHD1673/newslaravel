        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    ...
                    <div class="ms-auto"><a href="<?php echo e(route('admin.categories.create')); ?>" class="btn btn-primary radius-30 mt-2 mt-lg-0 <?php echo e($isReporter ? 'd-none' : ''); ?>"><i class="bx bxs-plus-square"></i>Thêm danh mục mới</a></div>
                </div>
                    ...
                    <table class="table mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th>Xem chi tiết</th>
                                <th>Ngày tạo</th>
                                <th class="<?php echo e($isReporter ? 'd-none' : ''); ?>">Chức năng</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="<?php echo e($isReporter ? 'd-none' : ''); ?>">
