<?php $__env->startSection('title','TDQ - Tin Nóng'); ?>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="post--item">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="post--img">
                                                                        <a href="<?php echo e(route('posts.show', $hotPosts_category[$j][$i] )); ?>"
                                                                            class="thumb"><img
                                                                                src="<?php echo e(asset($hotPosts_category[$j][$i]->image ? 'storage/' . $hotPosts_category[$j][$i]->image->path : 'storage/placeholders/placeholder-image.png'  )); ?>"
                                                                                alt=""></a>
                                                                        <a href="<?php echo e(route('categories.show', $hotPosts_category[$j][$i]->category)); ?>"
                                                                            class="cat"><?php echo e($hotPosts_category[$j][$i]->category->name); ?></a>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="post--info">
                                                                        <ul class="nav meta">
                                                                            <li><span><?php echo e($hotPosts_category[$j][$i]->author->name); ?></a></li>
                                                                            <li><span><?php echo e($hotPosts_category[$j][$i]->created_at->locale('vi')->diffForHumans()); ?></span></li>
                                                                            <li><a href="#"><i class="fa fm fa-eye"></i><?php echo e($hotPosts_category[$j][$i]->views); ?></span></li>
                                                                            <li><a href="<?php echo e(route('posts.show', $hotPosts_category[$j][$i] )); ?>"><i class="fa fm fa-comments"></i><?php echo e(count($hotPosts_category[$j][$i]->comments)); ?></a></li>
                                                                        </ul>


                                                                        <div class="title">
                                                                            <h2 class="h3" style="color:black"><a
                                                                                    href="<?php echo e(route('posts.show', $hotPosts_category[$j][$i] )); ?>"
                                                                                    class="btn-link"><?php echo e($hotPosts_category[$j][$i]->title); ?></a></h3>
                                                                        </div>
                                                                    </div>

                                                                    <div class="post--content">
                                                                        <p><?php echo e($hotPosts_category[$j][$i]->excerpt); ?></p>
                                                                    </div>

                                                                    <div class="post--action">
                                                                        <a class="btn btn-link" href="<?php echo e(route('posts.show', $hotPosts_category[$j][$i] )); ?>">Đọc thêm</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
