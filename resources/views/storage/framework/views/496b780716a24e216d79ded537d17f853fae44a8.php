<?php $__env->startSection("style"); ?>
    <link href="<?php echo e(asset('admin_dashboard_assets/plugins/vectormap/jquery-jvectormap-2.0.2.css')); ?>" rel="stylesheet"/>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <h4 class="my-1 text-info"><?php echo e($countPost); ?></h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <h4 class="my-1 text-danger"><?php echo e($countCategories); ?></h4>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <h4 class="my-1 text-success"><?php echo e($countAdmin); ?></h4>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <h4 class="my-1 text-warning"><?php echo e($countUser); ?></h4>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div>
                                            ...
                                            <h4 class="my-1"><?php echo e($countView); ?></h4>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div>
                                            ...
                                            <h4 class="my-1"><?php echo e($countComments); ?></h4>
                                        </div>
...
<?php $__env->startSection("script"); ?>
    <script src="<?php echo e(asset('admin_dashboard_assets/plugins/vectormap/jquery-jvectormap-2.0.2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin_dashboard_assets/plugins/vectormap/jquery-jvectormap-world-mill-en.js')); ?>"></script>
    <script src="<?php echo e(asset('admin_dashboard_assets/plugins/chartjs/js/Chart.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin_dashboard_assets/plugins/chartjs/js/Chart.extension.js')); ?>"></script>
    <script src="<?php echo e(asset('admin_dashboard_assets/plugins/jquery.easy-pie-chart/jquery.easypiechart.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin_dashboard_assets/js/index.js')); ?>"></script>
