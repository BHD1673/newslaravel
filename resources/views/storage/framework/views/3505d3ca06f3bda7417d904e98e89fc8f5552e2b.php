            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Danh mục <?php echo e($category->name); ?>c</li>
                    </ol>
                </nav>
            </div>
        </div>
