...
unset($__errorArgs, $__bag); ?>
									...
									<div class="mb-3 disabled:opacity-75">
										...
										<input type="text" <?php echo e($isEmployee ? 'disabled' : ''); ?> id="removeonlyinput" class="form-control" value="<?php echo e($tags); ?>" name="tags" data-role="tagsinput">
									</div>
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="mb-3">
										<div class="<?php echo e($isReporter ? 'd-none' : 'form-check form-switch'); ?>">
											<input onclick="toggleReasonField(this)" name="approved" <?php echo e($post->approved ? 'checked' : ''); ?> class="form-check-input" type="checkbox" id="flexSwitchChecked">
											<label class="form-check-label <?php echo e($post->approved ? 'text-success' : 'text-warning'); ?>" for="flexSwitchChecked">
												<?php echo e($post->approved ? 'Đã phê duyệt' : 'Chưa phê duyệt'); ?>
...
unset($__errorArgs, $__bag); ?>
									...
									<button  <?php echo e($postLog ? $postLog->role_log === 'admin' && $isEmployee ? 'disabled' : ''  : ''); ?> class="btn btn-primary" type="submit"><?php echo e($isEmployee ? 'Duyệt bài' : 'Sửa bài viết'); ?></button>
...
document.addEventListener('DOMContentLoaded', function() {
	...
	console.log(removedImagesInput);
...
<script>
function toggleReasonField(checkbox) {
