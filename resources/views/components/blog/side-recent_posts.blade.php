...
<div class="side">
    ...
    @foreach($recent_posts as $recent_posts)
        <div class="f-blog">
            <a href="{{ route('posts.show', $recent_posts) }}" class="blog-img" style="background-image: url({{ asset($recent_posts->image ?  $recent_posts->image->path : 'images/placeholders/placeholder-image.png') }});"></a>
