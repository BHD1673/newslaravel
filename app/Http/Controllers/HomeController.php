...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $posts = Post::where('approved', '=', 3)
            ->latest()
            ->withCount('comments')->paginate(8);

        // phân trang 8 bài
        $recent_posts = Post::where('approved', 1)->latest()->take(5)->get();
        ...
        $outstanding_posts = Post::where('approved', 3)->orderBy('views', 'DESC')->take(5)->get();
        ...
        foreach ($category_home as $category_item) {
            ...
            $stt_home = $stt_home + 1;
            if ($stt_home === 1)
                $post_category_home0 =  Post::latest()->withCount('comments')->where('approved', 3)->where('category_id', $category_item->id)->take(5)->get();
            if ($stt_home === 2)
                $post_category_home1 =  Post::latest()->withCount('comments')->where('approved', 3)->where('category_id', $category_item->id)->take(6)->get();
            if ($stt_home === 3)
                $post_category_home2 =  Post::latest()->withCount('comments')->where('approved', 3)->where('category_id', $category_item->id)->take(8)->get();
            if ($stt_home === 4)
                $post_category_home3 =  Post::latest()->withCount('comments')->where('approved', 3)->where('category_id', $category_item->id)->take(5)->get();
            if ($stt_home === 5)
                $post_category_home4 =  Post::latest()->withCount('comments')->where('approved', 3)->where('category_id', $category_item->id)->take(6)->get();
            if ($stt_home === 6)
                $post_category_home5 =  Post::latest()->withCount('comments')->where('approved', 3)->where('category_id', $category_item->id)->take(5)->get();
            if ($stt_home === 7)
                $post_category_home6 =  Post::latest()->withCount('comments')->where('approved', 3)->where('category_id', $category_item->id)->take(5)->get();
            if ($stt_home === 8)
                $post_category_home7 =  Post::latest()->withCount('comments')->where('approved', 3)->where('category_id', $category_item->id)->take(5)->get();
            if ($stt_home === 9)
                $post_category_home8 =  Post::latest()->withCount('comments')->where('approved', 3)->where('category_id', $category_item->id)->take(8)->get();
            if ($stt_home === 10)
                $post_category_home9 =  Post::latest()->withCount('comments')->where('approved', 3)->where('category_id', $category_item->id)->take(4)->get();
        }
    ...
    public function search(Request $request)
    {
        ...
        $posts = Post::latest()->withCount('comments')->where('title', 'like', '%' . $key . '%')->paginate(30);
    ...
    public function newPost()
    {
        ...
        // Bài viết mới nhất
        $recent_posts = Post::where('approved', 3)->latest()->take(5)->get();
        $categories  = Category::where('name', '!=', 'Chưa phân loại')->withCount('posts')->orderBy('created_at', 'DESC')->take(10)->get();

        /*----- Lấy ra 4 bài viết mới nhất theo các danh mục khác nhau -----*/
        $category_unclassified = Category::where('name', 'Chưa phân loại')->first();
        $posts_new[0] = Post::where('approved', 3)->latest()
            ->where('category_id', '!=', $category_unclassified->id)
            ->take(1)->get();
        $posts_new[1] = Post::where('approved', 3)->latest()
            ->where('category_id', '!=', $category_unclassified->id)
            ->where('category_id', '!=', $posts_new[0][0]->category->id)
            ->take(1)->get();
        $posts_new[2] = Post::where('approved', 3)->latest()
            ->where('category_id', '!=', $category_unclassified->id)
            ->where('category_id', '!=', $posts_new[0][0]->category->id)
            ->where('category_id', '!=', $posts_new[1][0]->category->id)
            ->take(1)->get();
        $posts_new[3] = Post::where('approved', 3)->latest()
            ->where('category_id', '!=', $category_unclassified->id)
            ->where('category_id', '!=', $posts_new[0][0]->category->id)
            ->where('category_id', '!=', $posts_new[1][0]->category->id)
            ->where('category_id', '!=', $posts_new[2][0]->category->id)
        ...
        // Bài viết nổi bật
        $outstanding_posts = Post::where('approved', 3)->approved()->where('category_id', '!=',  $category_unclassified->id)->take(5)->get();


        // Bài viết mới nhất
        $newPosts_category  = Post::where('approved', 3)->latest()->where('category_id', '!=',  $category_unclassified->id)->take(20)->get();
    ...
    public function hotPost()
    {
        ...
        // Bài viết nổi bật
        $outstanding_posts = Post::where('approved', 3)->where('category_id', '!=',  $category_unclassified->id)->take(5)->get();
        ...
        $hotPosts_category[0]  = Post::where('approved', 3)->where('category_id', $category_phap_luat->id)->orderBy('created_at', 'DESC')->take(4)->get();
        $hotPosts_category[1]  = Post::where('approved', 3)->where('category_id', $category_kinh_te->id)->orderBy('created_at', 'DESC')->take(4)->get();
        $hotPosts_category[2]  = Post::where('approved', 3)->where('category_id', $category_xa_hoi->id)->orderBy('created_at', 'DESC')->take(4)->get();
        $hotPosts_category[3]  = Post::where('approved', 3)->where('category_id', $category_khoa_hoc->id)->orderBy('created_at', 'DESC')->take(4)->get();
        $hotPosts_category[4]  = Post::where('approved', 3)->where('category_id', $category_the_gioi->id)->orderBy('created_at', 'DESC')->take(4)->get();
    ...
    public function viewPost()
    {
        ...
        // Bài viết mới nhất
        $viewPosts_category  = Post::where('approved', 3)->where('category_id', '!=',  $category_unclassified->id)->orderBy('views', 'DESC')->take(20)->get();
