    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    const adData = [
        {
            ...
            source: "Kiss Of Life vÆ°á»›ng cÃ¡o buá»™c sao chÃ©p BLACKPINK â€“ Sá»± tháº­t lÃ  gÃ¬?",
            title: "Kiss Of Life vÆ°á»›ng cÃ¡o buá»™c sao chÃ©p BLACKPINK â€“ Sá»± tháº­t lÃ  gÃ¬?",
        },
    ];
    ...
    let adHTML =
        ...
        adData
            .map(function (item) {
                return (
                    "<a class='ad-item-link' href='" +
                    item.link +
                    "' target='_blank'>" +
                    "<span class='mgid-unit mgid-rec-image-container'>" +
                    "<img class='mgid-rec-image' loading='eager' aria-hidden='true' src='" +
                    item.imageSrc +
                    "' alt='" +
                    item.title +
                    "'>" +
                    ...
                    "<span class='mgid-unit mgid-rec-text'>" +
                    item.title +
                    "</span>" +
                    "<span class='mgid-unit mgid-rec-source'>" +
                    item.source +
                    "</span>" +
